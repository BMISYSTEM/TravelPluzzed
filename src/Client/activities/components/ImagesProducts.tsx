...
const ImagesProducts = ({urlimagenes}:imagenes) => {
    ...
    console.log(urlimagenes?.length)
    console.log(urlimagenes)
    console.log(visibleImagen)
    ...
    return (
        <div className='relative flex flex-row mt-5'>
            <button onClick={()=>moveImagen(2)} className='absolute h-full bg-sky-900/50'>
            ...
            <button onClick={()=>moveImagen(1)} className='absolute ml-[97%] h-full bg-sky-900/50 w-full'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-white">
