...
export const Ayuda = () => {
 const [nombre,setNombre] = useState('')
   ...
   const enviarSolicitud = async(e:React.FormEvent) =>{
     ...
     try {
       toast.promise(ClienteAxios.post('/api/tour/ayuda',datos),{
   ...
   return (
     <section className="w-full h-full flex flex-col gap-2">
       ...
       <section className="w-full h-full flex flex-col items-center justify-center">
         <h1 className="text-2xl font-semibold ">Consultar soporte</h1>
         <form action="" onSubmit={enviarSolicitud} className="w-1/2 h-full flex flex-col mt-10">
           ...
           <label htmlFor="" className="text-lg font-semibold">Motivo</label>
           <textarea value={comentario} onChange={(e)=>setComentario(e.target.value)}  className="border py-2 px-2 border-blue-500 rounded-sm" />
           <div className="mt-10">
